...
import type { ActivationPixels } from './activationSummary';

// A canvas-shaped object: getContext stays optional (and is truthiness-tested
// below) because happy-dom's canvas has no usable 2D context.
...
export function heatColor(value: number, schemeId: unknown = settings.get('colorScheme')): string {
 ...
 */
export function drawInspection(canvas: CanvasLike, pixels: ActivationPixels, targetWidth = 84): void {
