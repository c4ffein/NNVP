...
/**
 * The slice of a Vue Flow node this module reads — structural on purpose,
 * NOT imported from @vue-flow/core (see the module comment).
 */
...
/** The Vue Flow viewport transform. */
...
function rayToBorder(origin: Point, target: Point, paneSize: PaneSize, padding: number) {
...
export default function offscreenIndicators(
  ...
  paneSize: PaneSize | null | undefined,
  padding = 28,
): OffscreenIndicator[] {
