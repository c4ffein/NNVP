...
//
// The board is typed STRUCTURALLY (not as BoardInterface): the predicates are
// polled with fakes in tests and must never throw, whatever they are given.
 ...
 * @param $d3 the $boardInterface instance
 */
export function inputShapeIsSet($d3: TutorialBoard): boolean {
 ...
 */
export function getStep(id: string): TutorialStep | undefined {
