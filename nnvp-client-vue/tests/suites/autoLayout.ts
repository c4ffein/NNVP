...
import type { LayoutEdge, LayoutGraph, LayoutNode } from '../../src/lib/AutoLayout/autoLayout';
...
import type { FlowStore } from '../../src/lib/FlowInterface/FlowGraphEditor';
import type { FlowEdge, FlowNode } from '../../src/types/model';

type Positions = ReturnType<typeof autoLayout>;
...
function makeStore(): FlowStore & { state: FakeStoreState } {
...
const rect = (graph: LayoutGraph, positions: Positions, id: string) => {
...
const overlap = (a: Rect, b: Rect) => a.x < b.x + b.width && b.x < a.x + a.width
  && a.y < b.y + b.height && b.y < a.y + a.height;

function expectNoOverlap(graph: LayoutGraph, positions: Positions, expect: Expect) {
